...
titl = tk.Label(
    window, text="Attendance AI KUC", bg="#1c1c1c", fg="white", font=("Verdana", 27, "bold"),
)
titl.place(x=525, y=12)

a = tk.Label(
    window,
    text="Welcome to Attendance AI KUC",
    bg="#1c1c1c",  # Dark background for the main text
    fg="white",  # Bright white text color
    bd=10,
